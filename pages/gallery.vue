    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-md-7">
          <div class="row mb-5">
            <div class="col-12">
              <h2 class="site-section-heading text-center animated fadeIn slow">Nature Gallery</h2>
            </div>
          </div>
        </div>
      </div>
      <div class="row" id="lightgallery">
        <div
          ...
          data-aos="fade"
          data-src="~/assets/images/big-images/nature_big_1.jpg"
        ...
        >
          <a href="#">
            <img src="~/assets/images/nature_small_1.jpg" alt="IMage" class="img-fluid" />
          </a>
        </div>
        <div
          class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item"
          data-aos="fade"
          data-src="~/assets/images/big-images/nature_big_2.jpg"
        ...
        >
          <a href="#">
            <img src="~/assets/images/nature_small_2.jpg" alt="IMage" class="img-fluid" />
          </a>
        </div>
        <div
          class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item"
          data-aos="fade"
          data-src="~/assets/images/big-images/nature_big_3.jpg"
        ...
        >
          <a href="#">
            <img src="~/assets/images/nature_small_3.jpg" alt="IMage" class="img-fluid" />
          </a>
        </div>
        <div
          class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item"
          data-aos="fade"
          data-src="~/assets/images/big-images/nature_big_4.jpg"
        ...
        >
          <a href="#">
            <img src="~/assets/images/nature_small_4.jpg" alt="IMage" class="img-fluid" />
          </a>
        </div>
        <div
          class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item"
          data-aos="fade"
          data-src="~/assets/images/big-images/nature_big_5.jpg"
        ...
        >
          <a href="#">
            <img src="~/assets/images/nature_small_5.jpg" alt="IMage" class="img-fluid" />
          </a>
        </div>
        <div
          class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item"
          data-aos="fade"
          data-src="~/assets/images/big-images/nature_big_6.jpg"
        ...
        >
          <a href="#">
            <img src="~/assets/images/nature_small_6.jpg" alt="IMage" class="img-fluid" />
          </a>
        </div>
        ...
        <div
          class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item"
          data-aos="fade"
          data-src="~/assets/images/big-images/nature_big_7.jpg"
        ...
        >
          <a href="#">
            <img src="~/assets/images/nature_small_7.jpg" alt="IMage" class="img-fluid" />
          </a>
        </div>
        <div
          class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item"
          data-aos="fade"
          data-src="~/assets/images/big-images/nature_big_8.jpg"
        ...
        >
          <a href="#">
            <img src="~/assets/images/nature_small_8.jpg" alt="IMage" class="img-fluid" />
          </a>
        </div>
        <div
          class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item"
          data-aos="fade"
          data-src="~/assets/images/big-images/nature_big_9.jpg"
        ...
        >
          <a href="#">
            <img src="~/assets/images/nature_small_9.jpg" alt="IMage" class="img-fluid" />
          </a>
        </div>
        ...
        <div
          class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item"
          data-aos="fade"
          data-src="i~/assets/mages/big-images/nature_big_1.jpg"
