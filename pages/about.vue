      ...
      <div class="row justify-content-center">
        <div class="col-md-7">
          <div class="row mb-5 site-section">
            <div class="col-12">
              <h2 class="site-section-heading text-center animated fadeIn slow">About Us</h2>
            </div>
          </div>

          <div class="row mb-5">
            <div class="col-md-7 animated slideInLeft">
              <img src="~/assets/images/img_2.jpg" alt="Images" class="img-fluid" />
            </div>
            <div class="col-md-4 ml-auto animated slideInRight">
              <h3>Our Mission</h3>
          ...
          <div class="row site-section animated slideInUp">
            <div class="col-md-6 col-lg-6 col-xl-4 text-center mb-5">
              ...
              <p
                class="mb-4"
              >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur ab quas facilis obcaecati non ea, est odit repellat distinctio incidunt, quia aliquam eveniet quod deleniti impedit sapiente atque tenetur porro?</p>
              <p>
